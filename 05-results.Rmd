...
ggplot(d1,aes(x = Data.Value, y = fct_relevel(Borough,'Staten Island','Queens', 'Brooklyn','Bronx'))) + 
  geom_boxplot() +
...
ggplot(d3,aes(x = Data.Value, y = fct_relevel(Borough,'Manhattan', 'Bronx','Staten Island','Brooklyn'))) + 
  geom_boxplot() +
  xlab('Value of indicator')+
  ylab('Borough')+
